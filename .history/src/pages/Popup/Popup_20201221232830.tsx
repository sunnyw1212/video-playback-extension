    ...
    <div className="App">
      <header className="App-header">
        ...
        <div className="container">
          <details>
            <summary className="u-text-align-left">Apply To</summary>
          ...
          <details className="u-margin-top-15">
            <summary className="u-text-align-left">Playback Speed</summary>
          ...
          <details className="u-margin-top-15">
            <summary className="u-text-align-left">Seek Interval</summary>
            <div className="u-flex">
              <button type="button">Rewind</button>
              <button type="button">Fast Forward</button>
            </div>
          </details>
        </div>
      </header>
