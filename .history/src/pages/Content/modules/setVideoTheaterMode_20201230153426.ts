...
const _setVideoTheaterMode = (
  ...
  if (isInTheaterMode) {
    const theaterClone = video.cloneNode(true) as HTMLVideoElement;
    theaterClone.classList.add('clone');
    theaterClone.controls = true;

    document.querySelector('body')!.style.visibility = 'hidden';
    document.querySelector('html')?.appendChild(theaterClone);
